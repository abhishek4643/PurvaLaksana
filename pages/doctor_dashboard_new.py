...
def main():
    ...
    if menu == "Patient Records":
        ...
        if analysis_results:
            ...
            with col1:
                include_letterhead = st.checkbox("Include PurvaLaksana Letterhead", value=True)
            ...
            if st.button("Generate Report"):
                with st.spinner("Generating medical report..."):
                    ...
                    filename = f"PurvaLaksana_MedicalReport_{patient_name}_{date_str}.pdf"
...
def create_medical_report(analysis_data, doctor_name, report_date, include_letterhead=True, include_signature=True, recommendations=None):
    ...
    if include_letterhead:
        ...
        elements.append(Paragraph("PurvaLaksana Medical Center", title_style))
